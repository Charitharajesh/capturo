...
import { P as ProtocolError, T as TimeoutWaitingForResponseErrorCode, u as utf8ToBytes, E as ExternalError, M as MissingRootKeyErrorCode, b as Certificate, l as lookupResultToBuffer, R as RequestStatusResponseStatus, U as UnknownError, d as RequestStatusDoneNoReplyErrorCode, e as RejectError, f as CertifiedRejectErrorCode, g as UNREACHABLE_ERROR, I as InputError, h as InvalidReadStateRequestErrorCode, i as ReadRequestType, k as Principal, m as IDL, n as MissingCanisterIdErrorCode, H as HttpAgent, o as encode, Q as QueryResponseStatus, p as UncertifiedRejectErrorCode, q as isV3ResponseBody, s as isV2ResponseBody, t as UncertifiedRejectUpdateErrorCode, v as UnexpectedErrorCode, w as decode, S as Subscribable, x as pendingThenable, y as resolveEnabled, z as shallowEqualObjects, A as resolveStaleTime, B as noop, D as environmentManager, F as isValidTimeout, J as timeUntilStale, K as timeoutManager, N as focusManager, O as fetchState, V as replaceData, W as notifyManager, X as hashKey, Y as getDefaultState, r as reactExports, Z as shouldThrowError, _ as useQueryClient, $ as useInternetIdentity, a0 as createActorWithConfig, c as createLucideIcon, a1 as Record, a2 as Variant, a3 as Service, a4 as Func, a5 as Vec, a6 as Opt, a7 as Nat, a8 as Text, a9 as Int, aa as o, ab as vt, j as jsxRuntimeExports, G as GradientButton } from "./index-C5Vn4MYE.js";
import { B as Badge, C as Calendar } from "./badge-BQ67gqLR.js";
import { m as motion, C as Card, b as CardHeader, c as CardTitle, d as CardDescription, a as CardContent } from "./proxy-Ct9ybTzp.js";
...
Service({
  "getBookingById": Func([BookingId], [Opt(Booking$1)], ["query"]),
  "getBookings": Func([], [Vec(Booking$1)], ["query"]),
  "submitBooking": Func([BookingInput], [BookingResult], [])
});
const idlFactory = ({ IDL: IDL2 }) => {
  ...
  const BookingResult2 = IDL2.Variant({ "ok": BookingId2, "err": IDL2.Text });
  return IDL2.Service({
    "getBookingById": IDL2.Func([BookingId2], [IDL2.Opt(Booking2)], ["query"]),
    "getBookings": IDL2.Func([], [IDL2.Vec(Booking2)], ["query"]),
    "submitBooking": IDL2.Func([BookingInput2], [BookingResult2], [])
  });
};
class Backend {
  ...
  async submitBooking(arg0) {
    if (this.processError) {
      try {
        ...
        return from_candid_BookingResult_n2(this._uploadFile, this._downloadFile, result);
      } catch (e) {
        this.processError(e);
        throw new Error("unreachable");
      }
...
function from_candid_BookingResult_n2(_uploadFile, _downloadFile, value) {
...
function Booking() {
  ...
  if (submitted) {
    return /* @__PURE__ */ jsxRuntimeExports.jsx("section", { className: "min-h-[80vh] flex items-center justify-center py-16 px-4", children: /* @__PURE__ */ jsxRuntimeExports.jsxs(
      motion.div,
      {
        ...
        children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "w-20 h-20 rounded-full gradient-cosmic glow-primary flex items-center justify-center mx-auto mb-6", children: /* @__PURE__ */ jsxRuntimeExports.jsx(CircleCheck, { size: 36, className: "text-white" }) }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("h2", { className: "font-display font-bold text-3xl text-foreground mb-3", children: "Booking Confirmed!" }),
          /* @__PURE__ */ jsxRuntimeExports.jsxs("p", { className: "text-muted-foreground mb-8 leading-relaxed", children: [
            "Your request has been submitted. We're matching you with the best nearby creators for",
            " ",
            /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-foreground font-medium", children: form.eventName }),
            "."
          ] }),
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsx("section", { className: "py-16 px-4", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "container mx-auto max-w-2xl", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsxs(
      motion.div,
      {
        ...
        children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx(Badge, { className: "mb-4 bg-primary/20 text-primary border-primary/30 px-4 py-1.5 text-sm font-semibold rounded-full", children: "📸 Instant Booking" }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("h1", { className: "font-display font-bold text-4xl sm:text-5xl text-foreground mb-3", children: "Book a Creator" }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-muted-foreground text-lg max-w-lg mx-auto", children: "Fill in your event details and we'll connect you with the perfect nearby creator." })
        ]
      }
    ),
    /* @__PURE__ */ jsxRuntimeExports.jsx(
      motion.div,
      {
        ...
        children: /* @__PURE__ */ jsxRuntimeExports.jsxs(Card, { className: "bg-card border-border/40 shadow-elevated", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsxs(CardHeader, { children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx(CardTitle, { className: "font-display text-xl text-foreground", children: "Event Details" }),
            /* @__PURE__ */ jsxRuntimeExports.jsx(CardDescription, { className: "text-muted-foreground", children: "Tell us about your event to find the right creator." })
          ] }),
            ...
            "form",
            {
              ...
              children: [
                /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex flex-col gap-3", children: [
                  /* @__PURE__ */ jsxRuntimeExports.jsx(Label, { className: "text-sm font-medium text-foreground", children: "Event Type" }),
                  /* @__PURE__ */ jsxRuntimeExports.jsx(
                    "div",
                    {
                      className: "flex flex-wrap gap-2",
                      "data-ocid": "booking-event-types",
                      children: eventTypes.map((type) => /* @__PURE__ */ jsxRuntimeExports.jsx(
                        "button",
                        {
                          type: "button",
                          onClick: () => handleEventType(type),
                          className: `px-3 py-1.5 rounded-full text-xs font-semibold border transition-smooth ${form.eventName === type ? "gradient-cosmic text-white border-transparent glow-primary" : "border-border/60 text-muted-foreground hover:border-primary/40 hover:text-foreground bg-muted/10"}`,
                ...
                /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex flex-col gap-2", children: [
                  /* @__PURE__ */ jsxRuntimeExports.jsxs(
                    Label,
                    {
                      ...
                      children: [
                        /* @__PURE__ */ jsxRuntimeExports.jsx(Tv, { size: 15, className: "text-primary" }),
                        "Event Name"
                      ]
                    }
                  ),
                ...
                /* @__PURE__ */ jsxRuntimeExports.jsx(
                  GradientButton,
                  {
                    ...
                    children: submitBooking.isPending ? "Submitting…" : "Find Creators Near Me"
                  }
                )
              ]
            }
